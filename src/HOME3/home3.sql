...
select * from books;
update books set autor_surname='Кулачков' where books_name="Гніздо Кажана";
update books set autor_surname='Николин' where books_name="Позывной «Крест»";
...
select count(*) from books where category = "Детективы";
...
select * from book where book_name like "%Рунета";
select * from book where book_name like "%трилогия%";
select * from book where book_name like "%Премия";
...
delete from books where title = "Мазепа";
delete from books where isbn = "9786171276123";
