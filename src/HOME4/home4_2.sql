...
insert into owners (name_of_owners, surname_of_owners, telephone, email,town_id,country_id) values
('Микола', 'Петренко', 968235091, 'email@mail.com',1,3),
('Omar', 'Nymiz', 487552901, 'ny@gmail.com',3,1),
('Richard', 'Grei', 318375420,  'grei@gmail.com',2,1);
...
alter table owners add foreign key(country_id) references countries(id);
